...
struct RotRect {
	Point2 TL, TR, BL, BR;
	int count;
	RotRect() : RotRect(Point2(), Point2(), Point2(), Point2(), count) {}
	RotRect(const Point2& TL, const Point2& TR, const Point2& BL, const Point2& BR, int count) : TL(TL), TR(TR), BL(BL), BR(BR), count(count){}
};
